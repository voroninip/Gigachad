...
IL_009a:
	{
		...
		L_27 = KeyValuePair_2_get_Value_m260B9EE987CF43F0DB7ADC6CFFFE1653A17FA382_inline(((L_25)->GetAddressAt(static_cast<il2cpp_array_size_t>(L_26))), il2cpp_rgctx_method(method->klass->rgctx_data, 20));
...
IL_0035:
	{
		...
		V_1 = L_10;
		int32_t L_11 = V_1;
		Dictionary_2_Resize_mBBCCD4EC70D1747519F76A7CDA40980A40A415D7(__this, L_11, (bool)0, il2cpp_rgctx_method(method->klass->rgctx_data, 44));
		int32_t L_12 = V_1;
		return L_12;
	}
}
